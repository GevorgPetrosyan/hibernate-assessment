...
public class CountryResource {
    ...
    @GetMapping("/getCountryByCount")
    public ResponseEntity<List<CountryResponseModel>> getUserCountByCountry() {
        List<CountryResponseModel> countryByUserCount = countryServiceImpl.getCountryByUserCount();
